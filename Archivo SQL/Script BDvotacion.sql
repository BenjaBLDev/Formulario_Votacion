...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-03-2023 a las 08:18:50
...
INSERT INTO `candidatos` (`candidato_id`, `nombre`) VALUES
(1, 'Francisco Larrondo'),
(2, 'Samuel Tapia'),
(3, 'Claudio Orrego'),
(4, 'Waldo García'),
(5, 'Jorge Tapia');
...
--
ALTER TABLE `candidatos`
  MODIFY `candidato_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
